...
public class DbManager {
    ...
    public void getDriveInfo(Drive drive) {
        ...
        String origin = drive.getOriginAddress();
        String destination = drive.getDestinationAddress();
        ...
        if(dbDriveInfo != null){
            if(dbDriveInfo.isInfoAvailable()){
                ...
                if(date < refreshDate){
                    ...
                    drive.setOriginAddress(dbDriveInfo.getOriginAddress());
                    drive.setDestinationAddress(dbDriveInfo.getDestinationAddress());
...
//                System.out.println("Info not available");
    ...
    public void addDriveInfo(Drive drive) {
        ...
        Call<Void> call = databaseService.addDriveInfo(
                drive.getOriginAddress(),
                drive.getDestinationAddress(),
